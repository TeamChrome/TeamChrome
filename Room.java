...
public class Room {
    ...
    public void setRoomNumber(int roomNumber) {
        if(roomNumber < 0 || roomNumber > MAXIMUM_ROOM_NUMBER){
            System.err.println("[Room.setRoomNumber] The given roomNumber is invalid" + String.valueOf(roomNumber));
            return;
        }
    ...
    public void setRoomLevel(int roomLevel) {
        if(roomLevel < 0 || roomLevel > MAXIMUM_ROOM_LEVEL){
            System.err.println("[Room.setRoomLevel] The given roomLevel is invalid" + String.valueOf(roomLevel));
            return;
        }
